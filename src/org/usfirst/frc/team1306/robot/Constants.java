 ...
 * @Constants
 * 
 * Where all "finalized" variables are stored
 * 
 * @author Jackson Goth
 */
...
public class Constants {
	...
	/** @Subsystem_Control (Switching to false will disable all output for that subsystem) */
	public final static boolean DRIVETRAIN_ENABLED = true;	
	
	/** @Intake_Constants */
	public final static double INTAKE_SPIT_TIME = 2.0;
